...
/*
 * @brief Print the current state of the orderbook. 
 */
 ...
 * 
 * @param price: Price - the price to place the order
 * @param quantity: Quantity  - the quantity of the order
 * @param side: Side - the side of the order (BUY or SELL)
 * @param orderType: OrderType - the type of order (LIMIT or MARKET order)
 * 
 * @return OrderConfirmation - An object containing the orderId of the created order, and the trades executed recently.
 */
...
/*
 * @brief Cancel an order to the orderbook.
 * 
 * @param orderId: OrderId - the orderId of the order to cancel
 */
...
/*
 * @brief Modify an order to the orderbook.
 * 
 * @param orderId: OrderId - the orderId of the order you want to modify
 * @param price: Price - the price to place the order
 * @param quantity: Quantity  - the quantity of the order
 * @param side: Side - the side of the order (BUY or SELL)
 * @param orderType: OrderType - the type of order (LIMIT or MARKET order)
 * 
 * @return OrderConfirmation - An object containing the orderId of the new modified order, and the trades executed recently.
 */
